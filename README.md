#  Portfólio Pessoal - Jackson Sousa

##  Descrição
Este é o meu **Portfólio pessoal**, desenvolvido com **HTML5**, **CSS3** e um pouco de **JavaScript**.  
Nele apresento minha trajetória profissional, habilidades, projetos e formas de contato.  
O objetivo é oferecer uma navegação rápida, moderna e responsiva.
...
- Links diretos para redes sociais (LinkedIn, GitHub)
